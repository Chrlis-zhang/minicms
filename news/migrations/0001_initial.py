# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-07 06:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank='', default='', verbose_name='内容')),
                ('published', models.BooleanField(default=True, verbose_name='正式发布')),
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
                ('update_tine', models.DateTimeField(auto_now=True, null=True, verbose_name='更新时间')),
